defmodule TinkerlogWeb.PostControllerTest do
  use TinkerlogWeb.ConnCase

  import Tinkerlog.BlogFixtures

  @create_attrs %{body: "some body", published_at: ~D[2022-12-22], slug: "some slug", title: "some title"}
